...
public class LetterDialogue : MonoBehaviour
{
    ...
    private NPCConversation letterConversation;
    private bool playerInRange = false;

    private void Start()
    {
        letterConversation = dialogueObject.GetComponent<NPCConversation>();
    ...
    private void Update()
    {
        ...
        if (playerInRange && Input.GetKeyDown(KeyCode.Return))
        {
            ...
            ConversationManager.Instance.StartConversation(letterConversation);
