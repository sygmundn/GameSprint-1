...
public class TreeDialogue : MonoBehaviour
{
    ...
    private NPCConversation treeConversation;
    private bool playerInRange = false;

    private void Start()
    {
        treeConversation = dialogueObject.GetComponent<NPCConversation>();
        if (treeConversation == null)
        {
    ...
    private void Update()
    {
        ...
        if (playerInRange && Input.GetKeyDown(KeyCode.Return))
        {
            ...
            ConversationManager.Instance.StartConversation(treeConversation);
