...
public class FridgeDialogue : MonoBehaviour
{
    ...
    private NPCConversation fridgeConversation;
    private bool playerInRange = false;

    private void Start()
    {
        fridgeConversation = dialogueObject.GetComponent<NPCConversation>();
        if (fridgeConversation == null)
        {
    ...
    private void Update()
    {
        ...
        if (playerInRange && Input.GetKeyDown(KeyCode.Return))
        {
            ...
            ConversationManager.Instance.StartConversation(fridgeConversation);
