...
public class SceneChangeController2 : MonoBehaviour
{
    ...
    public void KitchenToHallway(string Hallway, bool fromKitchen)
    {
        ...
        SceneManager.LoadScene("Hallway2"); // Use the provided scene name
    }
    ...
    public void HallwayToKitchen(string Kitchen, bool fromHallway)
    {
        ...
        SceneManager.LoadScene("Kitchen2"); // Use the provided scene name
    }
    ...
    public void HallwayToLivingRoom(string LivingRoom, bool fromHallway)
    {
        ...
        SceneManager.LoadScene("LivingRoom2"); // Use the provided scene name
    }
    ...
    public void HallwayToBathroom(string Bathroom, bool fromHallway)
    {
        ...
        SceneManager.LoadScene("Bathroom2"); // Use the provided scene name
    }
    ...
    public void HallwayToEntrance(string Entrance, bool fromHallway)
    {
        ...
        SceneManager.LoadScene("Entrance2"); // Use the provided scene name
    }
