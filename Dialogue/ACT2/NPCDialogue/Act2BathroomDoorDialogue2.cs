...
public class Act2BathroomDoorDialogue2 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if ((playerInRange && Input.GetKeyDown(KeyCode.Return)) && (GameManager2.Instance.spokeToBrother3) && (!GameManager2.Instance.spokeToBathroomDoor2) && (!ConversationManager.Instance.IsConversationActive))
        {
            ...
            GameManager2.Instance.spokeToBathroomDoor2 = true;
