...
public class Act2MomDialogue3 : MonoBehaviour
{
    ...
    private void Update()
    {
        if ((playerInRange && Input.GetKeyDown(KeyCode.Return)) && ((GameManager2.Instance.spokeToCousin3 >= 1) && (GameManager2.Instance.spokeToMom2 >= 1) && (GameManager2.Instance.spokeToAunt3 >= 1))
            && (!ConversationManager.Instance.IsConversationActive))
        {
            ...
            GameManager2.Instance.spokeToMom3 += 1;
