...
public class Act2UncleDialogue3 : MonoBehaviour
{
    ...
    private void Update()
    {
        if ((playerInRange && Input.GetKeyDown(KeyCode.Return)) && ((GameManager2.Instance.spokeToMom2 >= 1) && (GameManager2.Instance.spokeToUncle2 >= 1)) && (!ConversationManager.Instance.IsConversationActive))
        {
            ...
            GameManager2.Instance.spokeToUncle3 += 1;
