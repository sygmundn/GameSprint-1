...
public class Act2AuntDialogue2 : MonoBehaviour
{
    ...
    private void Update()
    {
        if ((playerInRange && Input.GetKeyDown(KeyCode.Return)) && (GameManager2.Instance.spokeToBrother2) && ((GameManager2.Instance.spokeToAunt2 < 1) || (GameManager2.Instance.spokeToCousin2 < 2))
            && (!ConversationManager.Instance.IsConversationActive))
        {
            ...
            if (playerController != null)
            {
                ...
                GameManager2.Instance.spokeToAunt2 += 1;
