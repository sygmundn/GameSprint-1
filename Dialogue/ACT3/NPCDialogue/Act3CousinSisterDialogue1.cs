...
public class Act3CousinSisterDialogue1 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (playerInRange && Input.GetKeyDown(KeyCode.Return) && GameManager3.Instance.spokeToCousinSister2 < 1)
        {
            ...
            if (playerController != null)
            {
                ...
                GameManager3.Instance.spokeToCousinSister1 += 1;
                Debug.Log("Spoke to CousinSister1: " + GameManager3.Instance.spokeToCousinSister1); // Display the count
