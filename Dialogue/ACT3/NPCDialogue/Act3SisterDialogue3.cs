...
public class Act3SisterDialogue3 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (playerInRange && Input.GetKeyDown(KeyCode.Return) && (GameManager3.Instance.spokeToCousinSister2 >= 1) && (!GameManager3.Instance.spokeToMom2))
        {
